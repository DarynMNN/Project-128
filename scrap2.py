...
browser = webdriver.Chrome('/Users/Owner/Desktop/Python/Class 128 Project/chromedriver.exe')
    ...
    try:
        ...
        for tr_tag in soup.find_all("tr", attrs = {"class":"fact_row"}):
            ...
            for td_tag in td_tags:
                try:
                    temp_list.append(td_tag.find_all("dif", attrs = {"class":"value"})[0].contents[0])
                except:
                    temp_list.append("")
